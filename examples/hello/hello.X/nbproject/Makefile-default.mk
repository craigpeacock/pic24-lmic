...
SOURCEFILES_QUOTED_IF_SPACED=../../../lmic/aes.c ../../../lmic/lmic.c ../../../lmic/oslmic.c ../../../lmic/radio.c ../../../pic24F/hal.c ../main.c ../../../pic24F/debug.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/32495530/aes.o ${OBJECTDIR}/_ext/32495530/lmic.o ${OBJECTDIR}/_ext/32495530/oslmic.o ${OBJECTDIR}/_ext/32495530/radio.o ${OBJECTDIR}/_ext/1274031625/hal.o ${OBJECTDIR}/_ext/1472/main.o ${OBJECTDIR}/_ext/1274031625/debug.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/32495530/aes.o.d ${OBJECTDIR}/_ext/32495530/lmic.o.d ${OBJECTDIR}/_ext/32495530/oslmic.o.d ${OBJECTDIR}/_ext/32495530/radio.o.d ${OBJECTDIR}/_ext/1274031625/hal.o.d ${OBJECTDIR}/_ext/1472/main.o.d ${OBJECTDIR}/_ext/1274031625/debug.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/32495530/aes.o ${OBJECTDIR}/_ext/32495530/lmic.o ${OBJECTDIR}/_ext/32495530/oslmic.o ${OBJECTDIR}/_ext/32495530/radio.o ${OBJECTDIR}/_ext/1274031625/hal.o ${OBJECTDIR}/_ext/1472/main.o ${OBJECTDIR}/_ext/1274031625/debug.o

# Source Files
SOURCEFILES=../../../lmic/aes.c ../../../lmic/lmic.c ../../../lmic/oslmic.c ../../../lmic/radio.c ../../../pic24F/hal.c ../main.c ../../../pic24F/debug.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/hello.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/hello.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -I"../../../lmic" -I"../../../pic24F"  -mreserve=data@0x800:0x81F -mreserve=data@0x820:0x821 -mreserve=data@0x822:0x823 -mreserve=data@0x824:0x825 -mreserve=data@0x826:0x84F   -Wl,,,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_ICD3=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/hello.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/hello.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -I"../../../lmic" -I"../../../pic24F" -Wl,,,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml$(MP_EXTRA_LD_POST) 
	${MP_CC_DIR}\\xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/hello.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf  
